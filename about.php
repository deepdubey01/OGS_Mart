  ...
  <div class="about_row">
    <div class="about_column">
      <div class="about_card">
        <div class="container_about">
          ...
          <p><span>Instagram: </span><a href="https://www.instagram.com/invites/contact/?i=1wpiuklqw8b50&utm_content=nzpz41q">deep.dubey01</a></p>
        </div>
      </div>
    </div>
    ...
    <div class="about_column">
      <div class="about_card">
        <div class="container_about">
          <h2>Aniket Pal</h2>
          <p class="title">Database And UI Manage</p>
          <p>Team Work, Self Motivaed, Honesty and Dedication</p>
          <p><span>Instagram: </span><a href="">aniketpal_20</a></p>
        </div>
      </div>
    </div>
